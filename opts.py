...
def parse_opts():
    ...
    parser.add_argument(
        '--frame_dir',
        default='/home/jupyter/HammadData/Frames/',
        type=str,
        help='path of jpg files')
    parser.add_argument(
        '--annotation_path',
        default='/home/jupyter/label_10',
        type=str,
        help='label paths')
    parser.add_argument(
        '--dataset',
    ...
    parser.add_argument(
        '--resume_path1',
        default='/home/jupyter/HammadData/Final_Data/10_cls/PreKin_UCF101_1_RGB_train_batch32_sample112_clip16_nestFalse_damp0.9_weight_decay1e-05_manualseed1_modelresnext101_ftbeginidx4_varLR390.pth',
        type=str,
